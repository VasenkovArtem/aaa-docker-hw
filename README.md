# Homework
Docker hometask at [Avito's Analytics Academy](https://avito-analytics-academy.ru/) Data Science course.
...
### Step 2. 
Dockerfile &mdash; uses python version 3.8 or higher as its base image, installs dependencies and runs `server.py` on port 8080. And after that it was built with tag `server:0.0.1`.
